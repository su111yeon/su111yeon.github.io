        ...
        for (let i = 1; i < e.length; i += 1) {
            ...
            if (null != r && ((a = r), !("undefined" != typeof window && void 0 !== window.HTMLElement ? a instanceof HTMLElement : a && (1 === a.nodeType || 11 === a.nodeType)))) {
                ...
                for (let s = 0, a = e.length; s < a; s += 1) {
                    ...
                    void 0 !== i &&
                        i.enumerable &&
                        (m(t[a]) && m(r[a]) ? (r[a].__swiper__ ? (t[a] = r[a]) : f(t[a], r[a])) : !m(t[a]) && m(r[a]) ? ((t[a] = {}), r[a].__swiper__ ? (t[a] = r[a]) : f(t[a], r[a])) : (t[a] = r[a]));
                }
            }
        }
        var a;
                ...
                (b = (function ({ userAgent: e } = {}) {
                    ...
                    return (
                        !p &&
                            m &&
                            t.touch &&
                            ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(`${l}x${o}`) >=
                                0 &&
